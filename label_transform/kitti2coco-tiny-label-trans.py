...
kitti_label_test_path = '/home/waynelin/temp/cmpe297/Homework2/COCO_styled_KITTI_tiny/kitti/labels/test/'
...
kitti_names = open('/home/waynelin/temp/cmpe297/Homework2/COCO_styled_KITTI_tiny/kitti.names', 'r')
...
for ind, img in enumerate(kitti_images):
    if ind < 600:
        ...
        f2.write(kitti_test_img_path + img + '\n')
    else:
        break
f.close()
f2.close()
